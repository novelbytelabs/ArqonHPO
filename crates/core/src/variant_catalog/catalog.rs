...
impl VariantConstraints {
    ...
    pub fn is_satisfied(&self, latency_p99_us: u64, memory_bytes: u64, quality: f64, cost: f64, gpu_type: &str) -> bool {
        ...
        if !self.required_gpu_types.is_empty() && !self.required_gpu_types.contains(&gpu_type.to_string()) {
            return false;
        }
        true
    }
