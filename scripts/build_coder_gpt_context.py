#!/usr/bin/env python3
"""Build Coder AI GPT governance context JSON for GitHub Pages.

Run from repo root:

    python3 scripts/build_coder_gpt_context.py

Inputs:
    shared/constitution/shared_gpt_constitution.md
    shared/constitution/coder_gpt_constitution.md
...
Output:
    shared/constitution/coder_gpt_context.json
"""
...
def main() -> None:
    ...
    coder = read_doc(
        "coder_gpt_constitution.md",
        "CODER_AI_GPT_CONSTITUTION",
    )
    ...
    context = {
        ...
        "authority_order": [
            ...
            "PM spec / task packet",
            "User request",
            "Coder convenience or preference",
        ],
        "fallback_policy": {
        ...
        "role_boundaries": {
            "allowed": [
                "write scoped implementation patches",
                "write scoped documentation patches",
                "write tests requested by PM scope",
                "write schemas requested by PM scope",
                "write CI/helper scripts requested by PM scope",
                "prepare Helper/Codex handoff packets",
                "identify ambiguity and unsafe requests",
            ],
            "forbidden": [
    ...
    context_hash = write_json("coder_gpt_context.json", context)
    print("Wrote shared/constitution/coder_gpt_context.json")
